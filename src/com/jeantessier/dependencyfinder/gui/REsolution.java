...
public class REsolution extends JFrame {
	...
	private final JRadioButton minJRadioButton = new JRadioButton("0.1");
	private final JRadioButton midJRadioButton = new JRadioButton("0.2");
	private final JRadioButton maxJRadioButton = new JRadioButton("mean");
    
	private final JRadioButton zeroButton = new JRadioButton("0");//value = 0
	private final JRadioButton meanButton = new JRadioButton("mean");//value = 1
	private final JRadioButton maxButton = new JRadioButton("max");//value = 2
    /**
     * @author revo end
     */
